...
export function useCashFlowMetrics() {
  ...
  // Per mantenere intatta la logica matematica senza scatenare re-render inutili,
  // forniamo mock vuoti per le fette di stato non necessarie al dominio CashFlow.
  const storeLiabilities = [];
  ...
  }, [settings, periods, accounts, transactions]);
